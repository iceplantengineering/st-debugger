...
export type ASTNodeType = 'PROGRAM' | 'FUNCTION_BLOCK' | 'FUNCTION' | 'VAR_DECLARATION' | 'ASSIGNMENT' | 'IF_STATEMENT' | 'FOR_LOOP' | 'WHILE_LOOP' | 'FUNCTION_CALL' | 'VARIABLE' | 'LITERAL' | 'BINARY_EXPRESSION' | 'CASE_STATEMENT' | 'REPEAT_LOOP';
...
export type IssueType = 'SYNTAX_ERROR' | 'RUNTIME_ERROR' | 'LOGIC_ERROR' | 'PERFORMANCE_ISSUE' | 'STYLE_VIOLATION' | 'SAFETY_CONCERN' | 'POTENTIAL_IMPROVEMENT' | 'CIRCULAR_DEPENDENCY' | 'UNUSED_VARIABLE';
...
export type ActivityType = 'PROJECT_CREATED' | 'FILE_UPLOADED' | 'CODE_ANALYZED' | 'ISSUES_FIXED' | 'VERSION_CREATED' | 'EXPORT_COMPLETED' | 'AI_ANALYSIS_RUN' | 'CODE_MODIFIED';
